...
ljs
        .addAliases({
            ...
            flat_ui:"assets/flat-ui/js/flat-ui.min.js",
            bootflat_main: "assets/bootflat/js/site.min.js",

            bootstrap_css:"assets/bootstrap/css/bootstrap.min.css",
            bootstrap_theme_css:"assets/bootstrap/css/bootstrap-theme.min.css",
            bootflat_main_css: "assets/bootflat-custom/css/site.min.css",
            flat_ui_css:"assets/flat-ui/css/flat-ui.min.css",
            app_css:"assets/app/css/main.css",

            bundle_js: ['jQuery','bootstrap','bootflat_main'],
            bundle_css: ['bootstrap_css', 'bootflat_main_css','app_css'],
        })
        .load('bundle_css');
